...
export const SavePin = () => {
    ...
    const saveinfo = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const descripcionimg = (event.target as HTMLFormElement).descripcionimg.value as string;
        const enlace = (event.target as HTMLFormElement).enlace.value as string;
        const categoria = (event.target as HTMLFormElement).categoria.value as string;
                            ...
                            <div className='flex justify-center items-center flex-wrap'>
                                ...
                                <section className='w-80 p-2 flex flex-col gap-9'>
                                    ...
                                    <figure className='flex items-center gap-3'>
                                        ...
                                        />
                                        <span>
                                            <h2>{(user as { displayName: string }).displayName || (user as { email: string }).email}</h2>
                                        </span>
                                    </figure>
                                    <figure>
                                        <input
