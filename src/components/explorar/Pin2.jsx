          ...
          <div key={photo.id} >
            ...
            <div className="group py-2 cursor-zoom-in relative overflow-hidden">
              <img
                ...
                alt={photo.titulo}
              />
              <span onClick={() => setPopap(photo.imagen, true)} className="absolute flex flex-col justify-between my-2 z-10 top-0 w-full bottom-0 bg-transparent pointer-events-none rounded-xl group-hover:bg-black/50 group-hover:pointer-events-auto ">
