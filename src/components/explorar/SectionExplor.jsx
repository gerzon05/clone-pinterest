...
export const SectionExplor = ({src,parragraf,title,handle}) => {
  return (
    <>
      <article onClick={handle} className="cursor-pointer hover:scale-95 relative w-[290px] h-[250px] md:w-[390px] md:h-[350px] rounded-2xl overflow-hidden mb-6">
        <img
          src={src}
          className="w-full object-cover object-[0,-200px]"
        />
