    ...
    <>
      ...
      <div className='mt-20 flex flex-col items-center justify-center relative'>
        ...
        <p className='w-[290px] sm:w-[600px] ms:w-[800px] py-3'>
          Descubre nuestra galería de fotos de carros, donde la elegancia y la
          potencia se fusionan en imágenes cautivadoras. Explora una variedad de
          modelos y marcas que despiertan la pasión por la conducción.
        </p>
      </div>
